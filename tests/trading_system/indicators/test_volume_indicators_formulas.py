...
AD_TEST_CASES = [
    ([Candle(0, 0, 62.15, 61.37, 62.34, 7849), Candle(1, 0, 60.81, 60.69, 62.05, 11692),
      Candle(2, 0, 60.45, 60.1, 62.27, 10575), Candle(3, 0, 59.18, 58.61, 60.79, 13059),
      Candle(4, 0, 59.24, 58.71, 59.93, 20734), Candle(5, 0, 60.2, 59.86, 61.75, 29630),
      Candle(6, 0, 58.48, 57.97, 60.00, 17705), Candle(7, 0, 58.24, 58.02, 59.00, 7259),
      Candle(8, 0, 58.69, 57.48, 59.07, 10475), Candle(9, 0, 58.65, 58.3, 59.22, 5204)],
     [4774.13, -4854.57, -12018.28, -18248.26, -20967.47, -39936.94, -48745.83, -52745.69, -47277.61, -48522.04])
]

OBV_TEST_CASES = [
    ([Candle(0, 0, 10, 0, 0, 25200), Candle(1, 0, 10.15, 0, 0, 30000),
      Candle(2, 0, 10.17, 0, 0, 25600), Candle(3, 0, 10.13, 0, 0, 32000),
      Candle(4, 0, 10.11, 0, 0, 23000), Candle(5, 0, 10.15, 0, 0, 40000),
      Candle(6, 0, 10.20, 0, 0, 36000), Candle(7, 0, 10.20, 0, 0, 20500),
      Candle(8, 0, 10.22, 0, 0, 23000), Candle(9, 0, 10.21, 0, 0, 27500)],
     [0, 30000, 55600, 23600, 600, 40600, 76600, 76600, 99600, 72100])
]

VRSI_TEST_CASES = [
    ([Candle(0, 61.42, 62.15, 61.37, 62.34, 7849), Candle(1, 62.15, 60.81, 60.69, 62.05, 11692),
      Candle(2, 60.81, 60.45, 60.10, 62.27, 10575), Candle(3, 60.45, 59.18, 58.61, 60.79, 13059),
      Candle(4, 59.18, 59.24, 58.71, 59.93, 20734), Candle(5, 59.24, 60.2, 59.86, 61.75, 29630),
      Candle(6, 58.23, 58.48, 57.97, 60.00, 17705), Candle(7, 58.48, 58.24, 58.02, 59.00, 7259),
      Candle(8, 58.24, 57.48, 61.37, 59.07, 10475), Candle(9, 57.48, 58.65, 58.3, 59.22, 5204)],
