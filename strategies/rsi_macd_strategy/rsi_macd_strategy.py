...
class RSIMACDStrategy(StrategyBase):
    ...
    def update(self) -> None:
        ...
        if self.last_macd_downtrend_ts >= self.last_macd_uptrend_ts and \
            ...
            self.ts.sell(self.asset_pair, 5, self.ts.get_buy_price())
